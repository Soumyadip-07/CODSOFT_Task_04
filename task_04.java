...
class task_04
{
    ...
    static void startTimer(Timer qtimer) 
    {
        ...
        qtimer.schedule(task, 10000);
    }
    public static void main(String args[])
    {
        System.out.println("***QUIZ APPPLICATION***");
        while (true)
        {
            System.out.println("1. Login.");
            System.out.println("2. Quiz Form.");
            ...
            switch(ch)
            {
                ...
                case 2:
                {
                    if(log)
                    {
                        System.out.println("Here is 10 quizes.");
                        System.out.println("You need to answer each quiz within 60 seconds.");
                        System.out.println("If you fail to answer any quiz within 60 seconds,\nYou will be out of the quizes.");
                        System.out.println("Let's Start...");
                        question();
                        System.out.println("Exam Completed...");
                        System.out.println("You have answered "+c+" quiz correctly.");
                    }
                    else 
                    {
